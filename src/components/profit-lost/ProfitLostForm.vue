                ...
                <template #content>
                    <div class="form-grid">
                        ...
                        <div class="form-fields">
                            <FormField id="kumulatif" :label="`Kumulatif`" type="number" v-model="formData.kumulatif"
                                placeholder="0" :error="errors.kumulatif" />
                            <FormField id="penarikan" :label="`Penarikan`" type="number" v-model="formData.penarikan"
            ...
            <FormSection title="Daftar Laba Rugi" description="Kumpulan item laba rugi yang telah ditambahkan">
                <template #content>
                    <div class="list-table">
                        <ProfitLostTable :current-page="currentPage" :page-size="pageSize" :entries="entries"
...
import { deleteProfitLost, getProfitLostList, postProfitLost, putProfitLost } from '@/services/profitLostService'
