        ...
        <template #content>
          <div class="form-grid">
            ...
            <div class="form-fields">
              ...
              <FormField id="pk-tambahan-data" label="PK Tambahan Data" type="number"
                v-model="formData.pk_tambahan_data" placeholder="0" :error="errors.pkTambahanData" />
              ...
              <FormField id="jumlah-pk" label="Jumlah PK" type="number" v-model="formData.jumlah_pk" placeholder="0"
                :error="errors.jumlahPk" />
              <FormField id="jumlah-pk-data" label="Jumlah PK Data" type="number" v-model="formData.jumlah_pk_data"
                placeholder="0" :error="errors.jumlahPkData" />
            </div>
          </div>
        </template>
      ...
      <FormSection title="Daftar Penjualan" description="Kumpulan item penjualan yang telah ditambahkan">
        <template #content>
          <div class="list-table">
            <PkColleteralGoodsTable :current-page="currentPage" :page-size="pageSize" :entries="entries" @edit="editRow"
              @delete="deleteRow" />
            <!-- PAGINATION -->
...
import { getPkColleteralGoodsList, postPkColleteralGoods, putPkColleteralGoods } from '@/services/pkColleteralGoods'
import type { PkColleteralGoodsData, PkColleteralGoodsFrm, PkColleteralGoodsPayload } from '@/types/pk-colleteral-goods.types'
