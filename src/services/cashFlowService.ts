...
import type { AddCashFlow, DeleteCashFlow, GetCashFlowList, ParamCashFlowList, UpdateCashFlow } from '@/types/cash-flow.type.ts';

export const getCashFlowList: GetCashFlowList = async (
...
export const putCashFlow: UpdateCashFlow = async (id, payload) => {
    ...
    try {
        ...
        notifySuccess({ title: 'Success Message', msg: data.message || 'Data kas keuangan berhasil diubah' })
        return data
    } catch (error: unknown) {
